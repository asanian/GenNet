...
--Remove the comment symbol from the following codes for finding constraints of paths
var
init_reg, acces : region;
init_reg := hNFKB =0 & hP21 =0 & hFOXM =0 & hPI3K =0 & hP53 =0 & hMDM2 =0 & hOGT =0 & hOGA =0 & hCMYC=0;
--Use either reach forward or post
--acces := reach forward from init_reg endreach;
acces := post(post(post(post(post(post(post(init_reg)))))));
acces:=hull(acces);
prints " Reachable States "; 
print hide hNFKB,hP21,hFOXM,hPI3K,hP53,hMDM2,hOGT,hOGA,hCMYC in acces endhide;
